...
[Contributors][sample-list-contributors-url]
[Forks][sample-list-forks-url]
[Stargazers][sample-list-stars-url]
[Issues][sample-list-issues-url]
[License][sample-list-license-url]

Este es el repositorio para el tercer laboratorio. Su objetivo es enseñar a los estudiantes cómo usar el ADT Lista, cómo configurar sus diferentes estructuras de datos y cómo integrarla en los scripts MVC del curso.
...
[DISClib][disclib-url] · [Ejemplos y Tutoriales DISClib][demo-url] · [Reportar Errores][sample-list-bugs-url] · [Solicitar Funcionalidades][sample-list-issues-url]
...
1. Daniel Felipe Diab G, d.diab@uniandes.edu.co, implementacion de single_linked
...
2. Carpeta [App](./App) con los scripts de Python Modelo-Vista-Controlador (MVC). Aquí los estudiantes implementan su código para completar las instrucciones de laboratorio.
3. [Data](./Data) Carpeta con archivos de datos CSV para cargar en la aplicación. Aquí los estudiantes agregan los archivos de datos proporcionados por el personal del curso para completar el laboratorio.
4. [Docs](./Docs) Carpeta con el informe, tabla de datos y otra documentación. Aquí los estudiantes agregan su informe de proyecto, tablas de datos y otros archivos para complementar su implementación de código.
...
* [Andrés Rodriguez ](https://github.com/afrodriguezm1)es el autor original y desarrollador principal del repositorio.
* [Daniel Alejandro Angel](https://github.com/danr844) es el principal contribuidor de este repositorio.
